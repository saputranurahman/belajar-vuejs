                    ...
                    <div class="relative flex flex-col min-w-0 rounded break-words border bg-white border-1 border-gray-300">
                        ...
                        <div class="flex-auto p-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" v-model="jumlah" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded">
                            </div>
                            <div class="mb-4">
                                <button class="inline-block align-midle text-center select-none border font-normal whitespace-no-wrap rounded no-underline bg-blue-600 text-white hover:bg-blue-600 py-1 px-2 leading-tight text-xs" @click="submitDonasi" :disabled="isLoading">
