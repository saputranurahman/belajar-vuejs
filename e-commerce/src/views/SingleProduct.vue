                        ...
                        <div class="lg:flex lg:items-start">
                            <div class="lg:order-2 lg:ml-5">
                                <div class="max-w-xl overflow-hidden rounded-lg">
                                    <img class="h-full w-full max-w-full object-cover" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTNhBHfd28t9yezsDR0mlJA64kfP1kr-5NWwQ&usqp=CAU" alt="" />
                                </div>
                            </div>
                            ...
                            <div class="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
                                <div class="flex flex-row items-start lg:flex-col">
                                    <button type="button"
                                        ...
                                        <img class="h-full w-full object-cover" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTNhBHfd28t9yezsDR0mlJA64kfP1kr-5NWwQ&usqp=CAU" alt="" />
                                    </button>
                                    <button type="button"
            ...
            <label class="">
              ...
              <p class="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold">12 Months</p>
                        ...
                        <div
                            ...
                            <button type="button"
                                class="inline-flex items-center justify-center rounded-md border-2 border-transparent bg-gray-900 bg-none px-11 py-3 text-center text-base font-bold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-gray-800">
                              <router-link to="/cart">
                    ...
                    <div class="lg:col-span-3">
                        ...
                        <div class="mt-8 flow-root sm:mt-12">
                            <p class="mt-4">mxbzbcdjbznxbcnzbcjkabjasbjbcBCsnbcj</p>
                        </div>
                    </div>
                </div>
            </div>
